...
func _draw() -> void:
	...
	draw_arc(Vector2.ZERO, RING1_R + 0.12, 0.0, TAU, 48, Color(tc.r, tc.g, tc.b, 0.07), 0.16)
	draw_arc(Vector2.ZERO, RING1_R + 0.07, 0.0, TAU, 48, Color(tc.r, tc.g, tc.b, 0.12), 0.10)
	draw_arc(Vector2.ZERO, RING1_R + 0.03, 0.0, TAU, 48, Color(tc.r, tc.g, tc.b, 0.18), 0.06)
